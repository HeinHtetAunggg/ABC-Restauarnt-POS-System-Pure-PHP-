///For Sticky Nav bar
const navbarEl=document.querySelector(".fixed_container");
const staffDetailContainerEl=document.querySelector(".staffdetail_container");

window.addEventListener("scroll",()=>{
    if(window.scrollY > staffDetailContainerEl.offsetTop-navbarEl.offsetTop-50){
...
///For Password Revealing Function

const passwordEl=document.querySelector("#password");
const eyeIconEl=document.querySelector("#eye");

eyeIconEl.addEventListener("click",()=>{
   if(eyeIconEl.classList.contains("fa-eye-slash")){
      passwordEl.setAttribute("type","text");
    //   eyeIconEl.classList.remove("fa-eye-slash");
    //   eyeIconEl.classList.add("fa-eye");
...
///For Advanced Weather App Function
